      ...
      <li class="nav-item">
        ...
        <div class="collapse" id="ui-basic">
          <ul class="nav flex-column sub-menu">
            <li class="nav-item"> <a class="nav-link" href="buttons.html">信息征集</a></li>
            <li class="nav-item"> <a class="nav-link" href="typography.html">用户管理</a></li>
          </ul>
        </div>
      </li>
      <li class="nav-item">
...
<style scoped>
@import "../../moban/static/css/feather.css";
@import "../../moban/static/css/themify-icons.css";
@import "../../moban/static/css/vendor.bundle.base.css";
@import "../../moban/static/css/style.css";
</style>